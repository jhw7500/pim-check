...
| respawn 후 ~30분 내 (10:16) | **재적용 → 백색 재진입** | 10:16~10:17 세션 ~500KB, 센서 16× 실측. ~~트리거 미상~~ → **동거 세션의 10:09Z gstApp 하네스(cam-operate 재기동+하드 리셋, ESTALE×2 후 복구)가 콜드 경로 재시작을 유발한 것으로 판명** (보드 공유 알림으로 확인, #26 코멘트 정정). 순수 "자발" 재적용 증거는 없음 |
